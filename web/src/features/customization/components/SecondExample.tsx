...
export const SecondExample = ({
	...
	const codeToCopy = `
    import { Button, InputField } from 'dialca-ui';
    export const CustomStyledComponents = () => {
        return (
	...
	return (
		<div className="bg-gray-900 dark:bg-gray-800 rounded-lg p-6 border border-gray-700">
			<div className="flex items-center justify-between mb-4">
				...
				<button
					onClick={() => copyToClipboard(codeToCopy, 201)}
			...
			<pre className="text-sm font-mono overflow-x-auto main-scroll">
				<code>
                    ...
                    <span className="text-indigo-400">CustomStyledComponents</span>{" "}
                    <span className="text-gray-400">=</span>{" "}
                    ...
                    <span className="text-gray-400">{">"}</span>
                    {"\n                "}
                    <span className="text-gray-200">Custom Gradient Button</span>
                    {"\n            "}
                    <span className="text-gray-400">{"</"}</span>
                    <span className="text-pink-400">Button</span>
                    <span className="text-gray-400">{">"}</span>
